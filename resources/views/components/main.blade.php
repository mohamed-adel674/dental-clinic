        ...
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 pl-4 pr-14 2xl:pl-0 2xl:pr-0">
            <ul class="flex flex-col md:flex-row items-center justify-center space-y-1 md:space-y-0 md:space-x-6 text-sm text-gray-400">
                ...
                <li class="flex items-center space-x-2">
                    ...
                    <a href="mailto:madelelmorshdy@gmail.com" class="hover:underline">{{ __('madelelmorshdy@gmail.com') }}</a>
                </li>
                <li class="flex items-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <a href="tel:+201558824126" class="hover:underline">{{ __('01558824126') }}</a>
                </li>
            </ul>
            <div class="flex items-center space-x-4">
                <a href="{{ route('lang.switch', app()->getLocale() == 'ar' ? 'en' : 'ar') }}" class="text-sm font-bold text-gray-500 hover:text-primary transition">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col items-center justify-center text-gray-500 text-sm py-4">
                <div>
                    ...
                    <a href="https://www.linkedin.com/in/mohamed-adel674/" class="text-primary hover:underline" target="_blank">
                        {{ __('Mohamed Adel') }}
                    </a>
                </div>
                <span>{{ date('M, Y') }}</span>
